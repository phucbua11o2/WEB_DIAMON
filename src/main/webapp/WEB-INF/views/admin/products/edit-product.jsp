			...
			<div class="row">
				<div class="span12">
					<div class="well">
						<hr> 
						<h3>Sửa sản phẩm</h3>
						<form:form action="${products.id}" method="POST" modelAttribute="products" class="form-horizontal" style="margin-left: 200px;"> 
							...
							<div class="control-group">
								<div class="controls">
									<button type="submit" class="btn block">Sửa sản phẩm</button>
								</div>
							</div>
						</form:form>
					</div>
